...
fn a() {
    ...
    for i in 0..3 {
        ...
        sink.append(SFX.get("sxf_1").unwrap().clone());
        std::thread::sleep(Duration::from_millis(500));
        sink.append(SFX.get("sxf_2").unwrap().clone());
    }    
}